...
필수 조건은 Python 3.12, NVIDIA CUDA GPU, FFmpeg입니다. 현재 설정은 8GB VRAM의 RTX 4070 Laptop GPU에서 실제 이미지 한 장 생성을 확인했습니다. Qwen3-4B와 SDXL은 최초 실행 때 Hugging Face Hub에서 로컬 캐시로 다운로드되므로 충분한 저장 공간과 시간이 필요합니다.
