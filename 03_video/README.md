...
필수 조건은 Python 3.12, NVIDIA CUDA GPU, FFmpeg, Ollama입니다. 8GB VRAM의 RTX 4070 Laptop GPU에서 SDXL 이미지 생성과 LTX 샘플의 로컬 실행을 확인했습니다. LTX는 CPU offload를 사용하므로 충분한 시스템 RAM과 swap이 필요하며, 최초 SDXL·LTX 모델 다운로드에는 수십 GB의 저장 공간과 시간이 필요할 수 있습니다.
